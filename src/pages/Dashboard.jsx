...
const Dashboard = ({ userName, userEmail, onLogout }) => {
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        const [produtosResult, clientesResult, vendas] = await Promise.all([
                ...
                <div className="card-content">
                  ...
                  >
                    <li style={{ marginBottom: '10px' }}>
                      📦 <strong>Produtos</strong> - Gerencie seu estoque de produtos
                    </li>
                    ...
                    <li style={{ marginBottom: '10px' }}>
                      🛒 <strong>Vendas</strong> - Registre suas vendas e acompanhe pedidos
                    </li>

                    <li style={{ marginBottom: '10px' }}>
                      📈 <strong>Relatórios</strong> - Visualize relatórios e análises
                    </li>
                  </ul>
                </div>
              </div>
